...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-copy-pointers.js",
      format: "umd",
      name: "capnpJsCopyPointers",
      sourcemap: true,
      globals: {
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-copy-pointers.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-copy-pointers.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-copy-pointers.js.map",
            },
          }))
